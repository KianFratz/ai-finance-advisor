      ...
      <div className="auth-panel">
        ...
        <div className="auth-panel-content">
          ...
          <div className="auth-panel-tagline">
            ...
            <p>Create your free account and let AI do the heavy lifting for your finances.</p>
          </div>
      ...
      <div className="auth-form-side">
        <div className="auth-form-card">
          <div className="auth-form-header">
            ...
            <p className="auth-form-desc">Join thousands who manage their money smarter</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="auth-form" noValidate>
            ...
            <div className="auth-field">
              <label htmlFor="monthly_income" className="auth-label">
                Monthly income <span className="auth-label-optional">(optional)</span>
              </label>
              <div className="auth-input-wrap">
              ...
              <p className="auth-field-hint">Helps us personalise your budget recommendations</p>
            </div>
